...
import com.hedroed.bellum.component.AnimationGun;
...
public class ShotgunWeapon extends Weapon{
	...
	public ShotgunWeapon(int range) {
		this.range = range;
		this.name = "ShotgunWeapon";
	}
	...
	public Animation getAnimation(Case dep, Case arr) {
		return new AnimationGun(dep.getXCoord()+0.5,dep.getYCoord()+0.5,arr.getXCoord()+0.5,arr.getYCoord()+0.5);
	}
